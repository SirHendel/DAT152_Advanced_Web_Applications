...
<body>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="password"
                    name="confirm_passwordnew"
                    placeholder="confirm new password" /></td>
            </tr>
            <tr>
            <tr>
                <td><input type="hidden" name="csrftoken"
                    value="${csrftoken}"></td>
            </tr>
            <tr>
                <td><p>
    ...
    <br>
    <p>
        <a href="searchpage">Back to Main search page</a>
    </p>
    <p>
        <b>You are logged in as ${user.username}. <a href="logout">Log
                out</a></b>
    </p>
